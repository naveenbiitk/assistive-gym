...
setup(name='assistive-gym',
    ...
    install_requires=['gym>=0.2.3', 'pybullet', 'trimesh', 'gymnasium==1.1.1' , 'smplx', 'numpy', 'keras', 'tensorflow', 'h5py',  'ray[rllib]', 'numpngw'] + ['screeninfo==0.6.1' if sys.version_info >= (3, 6) else 'screeninfo==0.2'],
